...
char myssid[] = "baglanirsan_ekime";          // your network SSID (name) 
char mypass[] = "nevereyimabime";          // your network password


//Credentials for Google GeoLocation API...
const char* Host = "www.googleapis.com";
String thisPage = "/geolocation/v1/geolocate?key=";
String key = "AIzaSyCuSCzBd-B4dqSmyjxtbA_FeaWzKfQNoc8";
...
//--------------------------------------------------------------------
 ...
 WiFiClientSecure client;
  ...
  Serial.println("https://" + (String)Host + thisPage + "AIzaSyCuSCzBd-B4dqSmyjxtbA_FeaWzKfQNoc8");
  Serial.println(" ");
  try{
