...
--
-- Name: AskUbuntuProject; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "AskUbuntuProject" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Turkish_Turkey.1254' LC_CTYPE = 'Turkish_Turkey.1254';


ALTER DATABASE "AskUbuntuProject" OWNER TO postgres;

\connect "AskUbuntuProject"
...
SELECT pg_catalog.setval('"Post"."Answers_AID_seq"', 1, false);
...
SELECT pg_catalog.setval('"Post"."Questions_QID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."Comments_ComID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."EmailVerification_EVID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Pictures_PictureID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Preferences_PrID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Privileges_PriID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."ProfileDetails_PID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."QuestionTags_QTID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Reputations_RepID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Tags_TID_seq"', 1, false);
...
ALTER TABLE ONLY "Post"."Answers"
    ADD CONSTRAINT "Answers_PID_fkey" FOREIGN KEY ("PID") REFERENCES "Post"."Posts"("PID");
...
ALTER TABLE ONLY "Post"."Questions"
    ADD CONSTRAINT "Questions_PID_fkey" FOREIGN KEY ("PID") REFERENCES "Post"."Posts"("PID");
